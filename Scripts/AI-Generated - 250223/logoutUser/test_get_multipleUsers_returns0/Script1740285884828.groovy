...
// Step 1: Create multiple Users with required fields 'username' and 'userStatus'
for (i in 0..2) {
    def userPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["username": "user_${i}__unique__", "userStatus": i])))
...
// Step 2: Execute GET /user/logout API
