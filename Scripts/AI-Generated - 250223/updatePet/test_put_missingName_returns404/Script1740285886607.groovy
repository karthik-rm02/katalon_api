...
def petPayload = '{"id": 1, "category": {"id": 2, "name": "Another Category"}, "photoUrls": ["http://example.com/image.jpg"]}'
...
def putPayload = '{"id": 1, "category": {"id": 2, "name": "Another Category"}, "photoUrls": ["http://example.com/image.jpg"]}'
