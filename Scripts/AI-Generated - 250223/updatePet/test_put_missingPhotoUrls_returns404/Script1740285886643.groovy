...
def categoryPayload = '{"id": 3, "name": "Third Category"}'
...
def petPayload = '{"id": 2, "category": {"id": 3, "name": "Third Category"}, "name": "Test Pet"}'
...
def putPayload = '{"id": 2, "category": {"id": 3, "name": "Third Category"}, "name": "Test Pet"}'
...
println("Step 4 - Response Status Code: ${putResponse.getStatusCode()}")
