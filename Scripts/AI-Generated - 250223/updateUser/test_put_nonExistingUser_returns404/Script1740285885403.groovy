...
def updatePayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": 1, "username": "non_existing_user__unique__", "firstName": "Jane", "lastName": "Smith", "email": "jane.smith@example.com", "password": "newpassword456", "phone": "9876543210", "userStatus": 2}'))
def updateUserRequest = findTestObject('Object Repository/kt session/Swagger Petstore/updateUser', ['username': 'non_existing_user__unique__'])
