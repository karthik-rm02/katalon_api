...
def username = userPayload.get("username", "default_username")
def updateUserRequest = findTestObject('Object Repository/kt session/Swagger Petstore/updateUser', ["username": username])
def updateUserPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(userPayload)))
