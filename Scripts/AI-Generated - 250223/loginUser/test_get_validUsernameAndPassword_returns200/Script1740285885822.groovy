...
def loginParams = new HashMap()
loginParams.put("username", "testUser__unique__")
loginParams.put("password", "testPassword")
def loginUserRequest = findTestObject('Object Repository/kt session/Swagger Petstore/loginUser', ["username": "testUser__unique__"])
loginUserRequest.setHttpBody(findTestObject('Object Repository/kt session/Swagger Petstore/loginUser', loginParams))
