...
def loginParams = ["password": "testPassword"]
def loginUserRequest = findTestObject('Object Repository/kt session/Swagger Petstore/loginUser', ["username": "testUser__unique__"])
loginUserRequest.setHttpBody(findTestObject('Object Repository/kt session/Swagger Petstore/loginUser_body', loginParams))
