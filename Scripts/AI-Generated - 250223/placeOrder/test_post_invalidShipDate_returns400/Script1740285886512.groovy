...
def payload = new HttpTextBodyContent(replaceSuffixWithUUID('{"petId": 1, "quantity": 1, "shipDate": "2022-01-01", "status": "placed", "complete": true}'))
...
println("Step 2 - Verify that the response status code is 400: ${orderResponse.getStatusCode()}")
