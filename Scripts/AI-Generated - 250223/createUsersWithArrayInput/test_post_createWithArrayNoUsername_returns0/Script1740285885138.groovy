...
def petPayload = '{"name": "Test Pet", "photoUrls": ["url1", "url2"], "category": {"id": 0, "name": "Test Category"}}'
...
def orderPayload = '{"petId": 0, "quantity": 1, "status": "placed", "complete": true}'
...
def userPayload = '{"id": 0, "firstName": "John", "lastName": "Doe", "email": "john.doe@example.com", "password": "password123", "phone": "1234567890"}'
