...
def invalidTagRequest = findTestObject('Object Repository/kt session/Swagger Petstore/findPetsByTags')
def invalidTagResponse = WSBuiltInKeywords.sendRequest(invalidTagRequest)
WSBuiltInKeywords.verifyResponseStatusCode(invalidTagResponse, 400)
