...
def delete_username = null
def delete_user_request = findTestObject('Object Repository/kt session/Swagger Petstore/deleteUser', ['username': delete_username])
...
assert delete_user_response.getResponseText('UTF-8') == '{"message":"Invalid username supplied"}'
